...
subroutine lee
   ...
   character(len=14)::ifile='TAVOC_2005.csv'
	logical :: lfil
	print *,"Inicia lectura"
    print *,"  ",ifile
	open (unit=10,file=ifile,status='old',action='read')
	read(10,*) cdum  ! header
...
200 continue
	...
	print *,'  Start count'
	call count  ! counts the different profiles number
...
!
  ...
  print *,'  Different cells number ',j
