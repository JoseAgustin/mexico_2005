...
! species and classes in a specific mechanism
!
!  compile: ifort -O2 -axAVX agg_m.f90 -o spm.exe
!
module var_agg
integer :: nh     !hours in a day
integer :: nclass !clasess number in profiles_spc.txt
integer :: nspecies ! max number species in profile 0 (292)
integer lfa  ! line number in area file TCOV_2005.csv
...
subroutine lee
	...
	logical :: lfil
	print *,"TMCOV_2005.csv"
	open (unit=10,file='TMCOV_2005.csv',status='old',action='read')
	read(10,*) cdum  ! header
	print *, cdum
