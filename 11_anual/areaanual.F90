...
!>   @date  05/24/2023
!>   @version 1.0
!>   @copyright Universidad Nacional Autonoma de Mexico 2026
module area_anual_mod
!> type day (1=Mon, 2= Tue, ... 7=Sun)
integer :: daytype ;!> number of emission files
integer,parameter :: nf=7    ;!> max number of scc descriptors in input files
...
character (len=19) :: current_date='2005-01-01_00:00:00'
 !> Input file name
...
&           'ACO__2005.csv','APM10_2005.csv',&
&           'APM25_2005.csv',&
&           'AVOC_2005.csv'/
 data casn /'MEX_AREA_9km_2005_SO2.nc ','MEX_AREA_9km_2005_NOx.nc ',&
&           'MEX_AREA_9km_2005_NH3.nc ','MEX_AREA_9km_2005_CO.nc  ',&
&           'MEX_AREA_9km_2005_PM10.nc',&
&           'MEX_AREA_9km_2005_PM25.nc','MEX_AREA_9km_2005_VOC.nc '/
 ...
 data ename/'SO2 ','NOx ','NH3 ','CO  ','PM10','PM25','VOC '/
 data cname / &
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "id","AE_2005_"//trim(ename(k))))
call check( nf90_put_att(ncid, NF90_GLOBAL, "title","Emissions from criteria pollutants and GHG for 2005"))
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "time_coverage_start","2005-01-01T06:00:00Z"))
call check( nf90_put_att(ncid, NF90_GLOBAL, "time_coverage_end","2006-01-01T05:00:00Z"))
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "summary","National emissions inventory for Mexico 2005&
...
call check( nf90_put_att(ncid, id_unlimit, "units", "years since 2005-01-01T06:00:00Z"))
...
!Tiempo
    call check( nf90_put_var(ncid, id_dim(1),"2005-01-01_06:00:00"))! one year output
...
subroutine lee_localiza
    ...
    flocaliza='../07_puntual/'//'localiza.csv'
