...
integer,parameter :: nf=7    ;!> max number of SCC IDs in input files
...
character (len=19) :: current_date='2005-01-01_00:00:00';!> output file name
...
character (len=40) :: titulo
 ...
 data efile / 'M_CO.csv' ,'M_NH3.csv','M_NOx.csv',&
              'M_SO2.csv',&
              'M_PM10.csv',&
              'M_PM25.csv','M_COV.csv'/

data casn /'MEX_MOBILE_9km_2005_CO.nc  ','MEX_MOBILE_9km_2005_NH3.nc ',&
           'MEX_MOBILE_9km_2005_NO2.nc ',&
           'MEX_MOBILE_9km_2005_SO2.nc ',&
           'MEX_MOBILE_9km_2005_PM10.nc','MEX_MOBILE_9km_2005_PM25.nc',&
           'MEX_MOBILE_9km_2005_VOC.nc '/
...
data ename/'CO  ','NH3 ','NO2 ','SO2 ','PM10',&
           'PM25','VOC '/
data cname / &
...
call check( nf90_put_att(ncid, NF90_GLOBAL, "id","ME_2005_"//trim(ename(k))))
